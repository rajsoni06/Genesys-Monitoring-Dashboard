    ...
    >
      <DropdownMenu open={open} onOpenChange={setOpen}>
        <DropdownMenuTrigger asChild>
          <button className="rounded-lg border-2 border-blue-200 dark:border-gray-600 shadow-sm hover:shadow-md transition-shadow duration-200">
            <div className="flex items-center gap-1 px-2 py-1 bg-amber-50 dark:bg-gray-800 hover:bg-amber-100 dark:hover:bg-gray-700 rounded-lg h-8">
  ...
  return (
    <nav className="h-14 bg-amber-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between px-4 sm:px-6 lg:px-8 shadow-sm">
      ...
      <div className="flex items-center gap-4">
        ...
        <a
          href="/"
          className="rounded-lg border-2 border-blue-200 dark:border-gray-600 shadow-sm hover:shadow-md transition-shadow duration-200"
          aria-label="Go to Home Page"
        >
          <div
            className="flex items-center gap-2 px-2 py-1 rounded-lg h-8"
            style={{
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <a
          ...
          className="rounded-lg border-2 border-blue-200 dark:border-gray-600 shadow-sm hover:shadow-md transition-shadow duration-200"
        >
          <div className="flex items-center gap-2 px-2 py-1 bg-amber-50 dark:bg-gray-800 hover:bg-amber-100 dark:hover:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 h-8">
            <span className="text-sm font-medium text-black dark:text-gray-200">
              Home
            </span>
          </div>
        ...
        >
          <div className="p-2 bg-amber-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600 h-8 flex items-center">
            {isDarkMode ? (
